...
public class ExplodeEnemy : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (!isExploding && Vector3.Distance(transform.position, playerTransform.position) < enemyStats.explodeDist)
        {
    ...
    {
        isExploding = true;  // Set the flag to true to prevent multiple explosions
        ...
        isExploding = false;  // Reset the flag when the explosion is complete
    }
